...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference("Articulo.count") do
      post articulos_url, params: { articulo: { condicion: @articulo.condicion, descripcion: @articulo.descripcion, marca_id: @articulo.marca_id, nombre: @articulo.nombre, precio: @articulo.precio } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { condicion: @articulo.condicion, descripcion: @articulo.descripcion, marca_id: @articulo.marca_id, nombre: @articulo.nombre, precio: @articulo.precio } }
